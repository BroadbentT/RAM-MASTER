...
def displayMenu():
   print('\u2554' + '\u2550'*14 + '\u2566' + '\u2550'*21 + '\u2566' + '\u2550'*33 + '\u2566' + '\u2550'*55 + '\u2566' + '\u2550'*(COL5+1) + '\u2557')
   print('\u2551' + " TIME " + colored(localTime[:5],colour1) + "   " + '\u2551' + " FILE " + colored(fileName[:14],colour1) + " " + '\u2551' + " HIVE         OFFSET LOCATION    "  + '\u2551' + " USERNAME " + " "*11 + " NTFS PASSWORD HASH " + " "*14 + '\u2551' + "     VIRUS TOTAL API INFORMATION     " + '\u2551') 
   print('\u2560' + '\u2550'*14 + '\u256C' + '\u2550'*21 + '\u256C' + '\u2550'*12 + '\u2566' + '\u2550'*20 + '\u256C' + '\u2550'*55 + '\u256C' + '\u2550'*(COL5+1) + '\u2563')
...
# ----------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   print('\u2551' + " API TOKEN", end=' ')
   if API_KEY == "":
      print(colored("NOT FOUND                ", colour2), end=' ')
   else: 
      print(colored("FOUND                    ", colour1), end=' ')
   print('\u2551')
...
# ----------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   if malicious == 0:
      ...
      print(colored("             MALICIOUS             ", 'red', attrs=['blink']), end=' ')
   print('\u2551')   
...
# -------------------------------------------------------------------------------------
   ...
   if selection == '88':
      if API_KEY != "":
         ...
         viral = input("")
         if viral != "":
            if os.path.exists(viral):
               os.system("md5sum " + viral + " > analyse.tmp")
